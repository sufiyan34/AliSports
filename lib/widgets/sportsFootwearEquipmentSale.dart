...
import 'package:alisportspk/widgets/sportsFootwearEquipmentSaleitems.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:responsive_builder/responsive_builder.dart';

class SportsFootwearEquipmentSale extends StatelessWidget {
  const SportsFootwearEquipmentSale({super.key});
          ...
          SliverToBoxAdapter(
            child: SizedBox(
                ...
                child: const Column(
                  ...
                  children: [
                    SportsFootwearEquipmentSaleitems(),
                    BrandsScrollingList(),
                    BottomPage(),
                  ],
                )),
