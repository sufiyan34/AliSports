...
class CricketingEquipmentSaleitems extends StatefulWidget {
  const CricketingEquipmentSaleitems({super.key});

  @override
  State<CricketingEquipmentSaleitems> createState() =>
      _CricketingEquipmentSaleitemsState();
}

class _CricketingEquipmentSaleitemsState
    extends State<CricketingEquipmentSaleitems> {
  ...
  void initState() {
    cricketProducts = Productinfo.productinfo
        .where((product) => product.mainCategory == "cricket")
        .toList();

    super.initState();
  }

  List<Productinfo> cricketProducts = [];
