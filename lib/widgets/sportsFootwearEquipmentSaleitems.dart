...
class SportsFootwearEquipmentSaleitems extends StatefulWidget {
  const SportsFootwearEquipmentSaleitems({super.key});

  @override
  State<SportsFootwearEquipmentSaleitems> createState() =>
      _SportsFootwearEquipmentSaleitemsState();
}

class _SportsFootwearEquipmentSaleitemsState
    extends State<SportsFootwearEquipmentSaleitems> {
  ...
  void initState() {
    desiredTypeproducts = Productinfo.productinfo
        .where((product) => product.precizeCategory == "shoes")
        .toList();
