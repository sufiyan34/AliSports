...
class ExerciseAndFitnesstSaleItems extends StatefulWidget {
  const ExerciseAndFitnesstSaleItems({super.key});

  @override
  State<ExerciseAndFitnesstSaleItems> createState() =>
      _ExerciseAndFitnesstSaleItemsState();
}

class _ExerciseAndFitnesstSaleItemsState
    extends State<ExerciseAndFitnesstSaleItems> {
  ...
  void initState() {
    desiredTypeproducts = Productinfo.productinfo
        .where((product) => product.mainCategory == "fitness & exercise")
        .toList();
