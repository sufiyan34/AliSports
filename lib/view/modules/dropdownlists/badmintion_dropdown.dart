...
class BadmintionDropdown extends StatefulWidget {
  const BadmintionDropdown({super.key});

  @override
  State<BadmintionDropdown> createState() => _BadmintionDropdownState();
}

class _BadmintionDropdownState extends State<BadmintionDropdown> {
  ...
  List<PlutoMenuItem> _makeMenus(BuildContext context) {
    return [
      PlutoMenuItem(
        title: 'Badminton Equipmentt',
        icon: Icons.keyboard_arrow_down,
        children: [
          PlutoMenuItem(
              title: 'Badminton Equipment',
              onTap: () {
                message(context, '_badmintonEquipment');
              },
              children: [
                ..._badmintonEquipment.map((e) {
                  //  int index = _badmintonEquipment.indexOf(e);
